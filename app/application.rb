...
module TorrentsPub
  ...
  class Application < Sinatra::Base
    set :views, File.expand_path('../assets/templates', __FILE__)
    ...
    def trackers
      @trackers ||= Trackers.new(YAML.load(File.read(File.join(TorrentsPub::Environment::CONFIG_ROOT, 'trackers.yml'))))
    end
  end
